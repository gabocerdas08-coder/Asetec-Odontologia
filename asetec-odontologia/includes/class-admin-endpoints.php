...
if ( ! function_exists('asetec_odo_get_events_array') ){
    function asetec_odo_get_events_array( $start, $end ){
        $q = new WP_Query([
...
class ASETEC_ODO_Admin_Endpoints_Impl {
    ...
    public static function events(){
        ...
        wp_send_json_success([ 'events' => asetec_odo_get_events_array($start,$end) ]);
    }
...
add_action('wp_ajax_asetec_odo_events',  ['ASETEC_ODO_Admin_Endpoints_Impl','events']);
add_action('wp_ajax_asetec_odo_approve', ['ASETEC_ODO_Admin_Endpoints_Impl','approve']);
add_action('wp_ajax_asetec_odo_cancel',  ['ASETEC_ODO_Admin_Endpoints_Impl','cancel']);