...
class ASETEC_ODO_Shortcode_Admin_Agenda {
    ...
    public function assets( $hook = '' ){
        // FullCalendar por CDN (ligero y confiable)
        ...
        // Nuestro JS (versionado para romper caché)
        $ver = time();
        ...
        wp_localize_script( 'asetec-odo-admin', 'ASETEC_ODO_ADMIN', [
            ...
            'bootstrapEvents' => [], // arrancamos sin bloquear por datos
            'i18n'  => [
