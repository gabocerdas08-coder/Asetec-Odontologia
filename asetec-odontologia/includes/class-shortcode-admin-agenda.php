...
class ASETEC_ODO_Shortcode_Admin_Agenda {
    ...
    public function assets(){
        ...
        // Nuestro JS (usa CDN, robusto y con modal)
        $ver = ASETEC_Odontologia::VERSION . '-ui';
        ...
        wp_localize_script( 'asetec-odo-admin', 'ASETEC_ODO_ADMIN', [
            ...
            'bootstrapEvents' => [], // arrancamos sin bloquear
            'i18n'  => [
    ...
    public function render(){
        ...
        ob_start(); ?>
        <style>
          /* UI limpia y compacta (sin archivo CSS extra) */
