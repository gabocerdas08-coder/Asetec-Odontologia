(function($){
  $(function(){
    ...
    if (typeof window.FullCalendar === 'undefined') {
      console.error('ASETEC ODO: FullCalendar no está disponible (CDN bloqueado o no cargó).');
      $('#odo-calendar').html('<p style="padding:12px;color:#b91c1c">No se pudo cargar el calendario (FullCalendar). Verifique la red/CSP.</p>');
      return;
    }
